        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">ناحیه ی متن قابل اندازه بندی
                        مجدد</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea class="resizable_textarea form-control"
                                              placeholder="این منطقه متن به طور خودکار تغییر ارتفاع می دهد تا بیشتر از ظرفیت پیش فرض آن متن وارد نمایید..."></textarea>
                    </div>
                </div>
            </div>
        </div>
