...
<div class="wrapper">
                ...
                <div class="content_box row">
                    <div class="col-lg-8 col-sm-12">
                        <div class="top">
                            ...
                            <div class="time">10 خرداد 1400</div>
                        </div>
                        <div class="bottom">
                            <p class="caption">
                    ...
                    <div class="col-lg-4 col-sm-12 row">
                        <div class="col-4">
                            <div class="visit_box">
                                ...
                                <span class="visit_number">200</span>
                            </div>
                        ...
                        <div class="col-4">
                            <div class="visit_box">
                                ...
                                <span class="like_number">200</span>
                            </div>
    ...
    <section id="package" class="d-none">
        <div class="container">
            ...
            <div class="package-items">
                <div class="row">
                    <div class="col-md-4 col-sm-12 notzoom">
                        <div class="p-item">
                            <div class="header pLeft">title</div>
                            <div class="caption">caption</div>
                            <div class="buyBox">
                                <a
                                    href="https://www.skyroom.online/skyroom/order"
                                    target="_blank"
                                    class="buy"
                                >
                                    button
                    ...
                    <div class="col-md-4 col-sm-12 zoom middleBox" id="freePackage">
                        <div class="p-item">
                            <div class="header pLeft">title</div>
                            <div class="caption">caption</div>
                            <div class="buyBox">
    ...
    <!-- brands -->
    <section id="brands" class="py d-none">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="p-item text-center">
                            <img
                                src="assets/images/snappLogo.png"
                                alt=""
                                loading="lazy"
                            />
                        </div>
    ...
    <footer class="d-none">
        <div class="content">
            ...
            <i
                class="fas fa-share-alt clipboard"
    ...
    <div class="copyright">
        <a
            href="https://harmony.agency/?utm_source=designbyharmony&amp;utm_medium=badge&amp;utm_campaign=dentalClinic-landing"
            target="_blank"
            ...
            <div class="modal-content">
                <div class="modal-body row">
                    ...
                    <div class="col-6">
                        <div class="content">
                            ...
                            <div class="steps step8">
                                ...
                                <p class="send_to_email">
                                    لینک تغییر رمز عبور به شماره 09123456789 ارسال شد
                                </p>
                                <a href="">
                                    <i class="fas fa-angle-left"></i>
                                    ورود به فروم عبیدی</a
                                >
                            </div>
                            ...
                            <div class="steps step9">
                                ...
                                <p class="send_to_email">
                                    لینک تغییر رمز عبور به ایمیل info@gmail ارسال شد
                                </p>
                                <a href="">
                                    <i class="fas fa-angle-left"></i>
                                    ورود به فروم عبیدی</a
                    ...
                    <div class="col-6 modal_img_box">
                        ...
                        />
                        <img
                            src="assets/images/modal_logo.png"
                            alt=""
                            class="modal_logo"
                        />
                    </div>
